...
class ClientDal {
    ...
    */
    ...
    /**
     * ajoute un client
     * @param   string  $strNom : le nom du client à ajouter
     * @param   string  $strPrenom : le prénom du client à ajouter
     * @param   string  $strAlias : l'alias du client à ajouter
     * @param   string  $strNotes : les notes concernant le client à ajouter
    ...
    */
     ...
     * @return le nombre d'ouvrages du client
    */
