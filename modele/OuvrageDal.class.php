...
class OuvrageDal {
    ...
    */
     ...
     * ajoute un ouvrage
    */
    public static function addOuvrage($strTitre, $intSalle, $strRayon, $strGenre, $strDate_acquisition) {
        $cnx = new PdoDao();
    ...
    */
    ...
    /**
     * supprime un ouvrage
     * @param   int $id : l'id de l'ouvrage à supprimer
    ...
    */
    ...
    /**
     * set le genre d'un ouvrage
     * @param   int $unGenre : le code du genre à set sur l'ouvrage
     * @return le nombre de lignes affectées
    */
    ...
    */
    ...
    /**
     * Ajoute un ou plusieurs auteurs à un ouvrage
    */
