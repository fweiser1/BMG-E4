<?php
/**
 * Page d'ajout d'un ou plusieurs auteurs a un ouvrage
...
<div id="content">
    ...
    <div id="object-list">
        <form action="index.php?uc=gererOuvrages&action=ajouterAuteur&option=validerAuteur&id=<?php echo $_GET['id'] ?>" method="post">
